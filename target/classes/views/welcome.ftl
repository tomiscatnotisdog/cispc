                                ...
                                <div class="welcome-module">
                                    <div class="layui-row layui-col-space10 layuimini-qiuck">
                                        ...
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="${ctx}/menu"  data-title="菜单管理"
                                        ...
                                        <#--系统设置-->
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="${ctx}/setting"  data-title="系统设置"
                                        ...
                                        <#--404页面-->
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="${ctx}/404"  data-title="404页面"
                                        ...
                                        <#--按钮实例-->
                                        <div class="layui-col-xs3 layuimini-qiuck-module">
                                            <a href="${ctx}/button" data-title="按钮示例"
                    ...
                    <div class="layui-card-body layui-text">
                        <table class="layui-table">
                            ...
                            <tr>
                                <td>演示地址</td>
                                <td>
                                    登陆页面：<a href="http://localhost:8080/cispc/index" target="_blank">点击查看</a><br>
                                </td>
                            </tr>
                            <tr>
                                <td>下载地址</td>
                                <td>
                                    github：<a href="https://github.com/tomiscatnotisdog/cispc"
                                              target="_blank">cispc项目下载</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
